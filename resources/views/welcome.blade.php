...
<div class="hero-image">
    <div class="hero-content">
        <div class="col-md-4 hero-text">
            ...
            <p>Welcomoe to LPU's Dental Center</p>
            <button class="btn custom-border my-2 my-sm-0">Services</button>
...
<div class="container">
    <div class="content-head">
        <h2 style="text-align:center; font-weight: bold">Dental Center</h2>
        <p style="text-align: center">LPU DENTAL FACILITY,PHAGWARA</h2>
    </div>
    <h2 class="header text-center">Featured Services</h2>
    <!-- start products row -->
    <div class="row">
    ...
    <hr>
    <h2 class="header text-center">Thanks for visiting</h2>
