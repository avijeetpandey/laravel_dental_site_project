...
Route::get('/services', 'ShopController@index')->name('shop.index');
Route::get('/services/{product}', 'ShopController@show')->name('shop.show');
Route::get('/services/search/{query}', 'ShopController@search')->name('shop.search');
